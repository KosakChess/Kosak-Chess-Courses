...
export const Hero = () => {
	...
	return (
		<section className="relative -top-[72px] isolate flex h-screen w-screen items-center justify-center overflow-hidden pt-14">
			...
			/>
			<div className="absolute inset-0 -z-10 bg-black opacity-60 dark:opacity-75" />
			<div
				aria-hidden
			...
			>
				<div
					...
					className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-primary to-[#9089fc] opacity-50 dark:opacity-20 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
				/>
			</div>
		</section>
	);
